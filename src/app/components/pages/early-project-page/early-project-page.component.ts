...
export class EarlyProjectPageComponent implements OnInit {
  ...
  changeMetaTitle(event: any) {
    this.hasChanges = true;
    this.earlyProjects[event.index].meta_title = event.title;
  }

  changeMetaTag(event: any) {
    this.hasChanges = true;
    this.earlyProjects[event.index].meta_tag = event.title;
  }

  changeMetaDescription(event: any) {
    this.hasChanges = true;
    this.earlyProjects[event.index].meta_description =
  ...
  builtupChange(event: any) {
    this.hasChanges = true;
    this.earlyProjects[event.index].project_built_up_area = event.built_up_area;
  }
  ...
  onPublish() {
    ...
    this.service.postERPojectPageData(this.earlyProjects).subscribe((data) => {
