...
export class UrbanismProjectPageComponent implements OnInit {
  ...
  changeMetaTitle(event: any) {
    this.hasChanges = true;
    this.urbanismProjects[event.index].meta_title = event.title;
  }

  changeMetaTag(event: any) {
    this.hasChanges = true;
    this.urbanismProjects[event.index].meta_tag = event.title;
  }

  changeMetaDescription(event: any) {
    this.hasChanges = true;
    this.urbanismProjects[event.index].meta_description =
